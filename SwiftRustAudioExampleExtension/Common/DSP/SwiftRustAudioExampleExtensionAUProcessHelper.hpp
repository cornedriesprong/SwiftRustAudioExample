//
//  SwiftRustAudioExampleExtensionAUProcessHelper.hpp
...
#include <vector>
#include "SwiftRustAudioExampleExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(SwiftRustAudioExampleExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    SwiftRustAudioExampleExtensionDSPKernel& mKernel;
